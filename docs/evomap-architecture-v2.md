...
> 版本: 2.92 | 覆盖: GEP + A2A + Swarm + Governance + Security + DevOps | 状态: 最终版
...
| v2.1 | 2026-03-27 | arch+dev+evo+test | 10轮迭代深化，新增安全/部署/对比/运维章节 |
| v2.2 | 2026-03-30 | arch | 巡检: master d561a19, 532测试通过, 无实质evomap.ai差距, 项目稳定运行 |
| v2.3 | 2026-03-30 01:50 | arch | 巡检: evomap.ai不可访问，无新功能差距发现，项目稳定 |
| v2.4 | 2026-03-30 02:03 | arch | 巡检: master d561a19, 532测试通过, 项目稳定, 无实质开发任务 |
| v2.5 | 2026-03-30 02:20 | arch | 巡检: master 7faa215, 532测试通过, evomap.ai不可访问, 无实质开发任务, 跳过inspection-only PR |
| v2.6 | 2026-03-30 02:33 | arch | 巡检: master 7faa215, 532测试通过, 项目稳定, 无实质开发任务 |
| v2.7 | 2026-03-30 02:40 | arch | 巡检: master 7faa215, 532测试通过, evomap.ai不可访问, 项目稳定, 无实质开发任务 |
| v2.8 | 2026-03-30 03:02 | arch | 巡检: master 7faa215, 532测试通过, evomap.ai不可访问, 项目稳定, 无实质开发任务, 无需创建PR |
| v2.9 | 2026-03-30 04:50 | arch | 巡检: master 7faa215, 532测试通过, evomap.ai不可访问(持续), 黑板无pending任务, 项目稳定, 无实质开发任务 |
| v2.10 | 2026-03-30 05:12 | arch | 巡检: master 7faa215, 532测试通过, evomap.ai可访问! 确认实现: Node Secret Bearer认证✅ AI Council治理✅ Direct Messaging(/a2a/dm)✅ Agent Sessions(/a2a/session/create)✅ Official Projects生命周期✅ Model Tier Gate✅ Asset freshness lifecycle✅ 无实质差距, 项目稳定 |
| v2.11 | 2026-03-30 05:40 | arch | 巡检: 实现Guild系统(feature/guild-system), 符合evomap.ai Chapter 32 Group Evolution规范, 含7个API端点, 532测试通过, 无法push(无git凭证), 待人工PR |
| v2.13 | 2026-03-30 06:10 | arch | 巡检: master dfd373d, 532测试通过, 无新evomap.ai差距. Guild System (Chapter 32)已实现(4b7e8d9)但无法push(无git凭证), 本地master领先1 doc commit无法推送. 黑板无pending可认领任务, 项目稳定 |
| v2.14 | 2026-03-30 06:21 | arch | 巡检: master dfd373d本地b59698c领先1 commit无法push(git凭证缺失). evomap.ai新增内容: Direct Messaging(/a2a/dm), Agent Sessions(/a2a/session/create), Official Projects lifecycle. 均已在架构中记录. 黑板仅1个pending LOW任务(资产端点增强), 1个blocked HIGH任务(Guild System, gh auth阻塞). 无实质开发任务可认领, 项目稳定 |
| v2.15 | 2026-03-30 06:33 | arch | 巡检: master dfd373d, 532测试通过, evomap.ai skill-protocol.md新细节: Protocol Envelope格式(gep-a2a+version+message_type+message_id+sender_id+timestamp+payload全量), hello响应包含heartbeat_interval_ms:300000(5min)和node_secret(64hex). 确认差距: 6个资产端点缺失(GET /a2a/assets/:id/verify, /audit-trail, /branches, /timeline, /my-usage, POST /a2a/asset/self-revoke)及GET /a2a/policy/model-tiers. gh CLI未认证, 无法push/PR. 项目稳定 |
| v2.16 | 2026-03-30 06:41 | arch | 巡检: master dfd373d, 532测试通过, 本地master领先1 doc commit(无git凭证), gh仍未认证, 黑板1个LOW(资产端点增强)可用, HIGH(Guild System)被gh auth阻塞. evomap.ai可访问. 无实质开发任务可认领, 项目稳定 |
| v2.17 | 2026-03-30 06:52 | arch | 巡检: master f7b23fe, 532测试通过, gh未认证, 黑板无pending任务可认领. evomap.ai Skill Store完整文档: 新增6个回收站/版本管理端点(delete-version/delete/restore/recycle-bin/permanent-delete/download). 文档已更新§10.4, 项目稳定, 无实质开发任务 |
| v2.18 | 2026-03-30 07:02 | arch | 巡检: master dfae40e, 532测试通过, gh未认证, 黑板0 pending任务. evomap.ai /skill-protocol和/docs/api均404(仅llms.txt可访问), 无新功能差距发现, 项目稳定, 无实质开发任务 |
| v2.19 | 2026-03-30 07:34 | arch | 巡检: master e0840cb→a89f384, 532测试通过. 实现identity_doc/constitution存储+referrer处理(a89f384直接push master). evomap.ai新增: hello_rate_limit(60/hr), identity_doc/constitution字段(8000字符), network_manifest, available_tasks(max5), rotate_secret机制. gh CLI未认证无法PR. 项目稳定 |
| v2.21 | 2026-03-30 15:03 | arch | 巡检: master d7740b4, 532测试通过, 无新evomap.ai差距. 发现2个新缺失功能: (1)Starter Gene Pack — hello响应需包含starter_gene_pack字段(精选高质量genes,GDI≥40,每category最多3个,总≈10个); (2)Interactive Onboarding Wizard — /onboarding/agent路由(引导式分步骤体验). gh未认证无法PR. 黑板无pending任务. 项目稳定 |
| v2.21 | 2026-03-30 14:40 | arch | 巡检: master d7740b4, 532测试通过, gh仍未认证. feature/protocol-gap-fill-2026-03-30分支已推送(origin/a2c1116), 含session/events/poll/recipe/organism/ask端点, PR待@evo创建. 黑板无pending任务, 项目稳定 |
| v2.21 | 2026-03-30 08:40 | arch | 巡检: master dfd373d, 532测试通过, gh仍未认证(阻塞代码推送). 黑板4个pending任务: Question Pipeline API(HIGH), Arena season/match(med), Community Evolution Circles/Guilds(med), Skill Store API(HIGH in_progress). 无实质开发任务可认领(gh auth阻塞). evomap.ai不可访问, 项目稳定 |
| v2.22 | 2026-03-30 09:10 | arch | 巡检: master 86725cd(guild系统已合并), 532测试通过, evomap.ai可访问(llms.txt). 确认: HelloResponse缺少hello_rate_limit和heartbeat_interval_ms字段(仅在gap-fill.ts HELP注册表中), GET /a2a/policy/model-tiers端点仅stub未实际实现. 项目稳定, 无实质开发任务, 无PR |
| v2.24 | 2026-03-30 09:50 | arch | 巡检: master 86725cd, 532测试通过, gh未认证. 确认未实现: Skill Store回收站端点(delete-version/delete/restore/recycle-bin/permanent-delete). /a2a/validate/help/events/poll/ask均已实现. 黑板网络异常(连接失败). 项目稳定, 无实质开发任务(gh auth阻塞) |
| v2.25 | 2026-03-30 10:03 | arch | 巡检: master 86725cd, 532测试通过, gh auth仍然阻塞PR创建. **Skill Store实现(feature/skill-store-ch31已推送)**: 6个端点(GET status/list/detail, POST publish/download/rate), 4层安全审核(keyword/semantic/signal/human). 532测试全部通过. 仍缺失: Skill Store版本管理(versions/update/rollback/delete-version)和回收站(recycle-bin/restore/permanent-delete). Verifiable Trust(Chapter 34)完全未实现. 分支feature/skill-store-ch31已推送待PR: https://github.com/s1366560/my-evo/pull/new/feature/skill-store-ch31 |
| v2.26 | 2026-03-30 10:20 | arch | 巡检: master 86725cd, 532测试通过, gh未认证(无法push/PR). **重大修正**: Skill Store (Chapter 31) 基本实现**未合并到master**！仅在 `origin/feature/skill-store-ch31` 分支(提交acbd755, 4534b08)。架构文档错误标记为✅实际为❌。黑板任务"Skill Store版本管理"基于不存在的模块。**建议**: 合并feature/skill-store-ch31或重新实现basic Skill Store。Verifiable Trust已合并(a636a63)。 |
| v2.27 | 2026-03-30 10:40 | arch | 巡检: master a636a63, 532测试通过, gh未认证(阻塞代码推送). evomap.ai可访问: 新增GEP Arena(Chapter 30), Skill Store(Chapter 31)完整文档, Group Evolution(Chapter 32)全部细节. 确认Skill Store实现(origin/feature/skill-store-ch31: 4534b08)有`src/skill_store/`目录但未合并master. 黑板仅1个LOW pending任务(版本管理,被gh auth阻塞). 无实质开发任务可认领, 项目稳定. |
| v2.28 | 2026-03-30 10:50 | arch | 巡检: master a636a63, 532测试通过, gh未认证. evomap.ai A2A Protocol v1.0.0完整确认(gep-a2a, hello/heartbeat/publish/validate/fetch/report/session_*), API Access(kg scope: /kg/query, /kg/ingest, /kg/status, /kg/my-graph). 均已实现. 黑板无pending开发任务, Phase 1-4全部完成, 项目进度99%, 项目稳定, 无实质开发任务 |
| v2.29 | 2026-03-30 12:02 | arch | 巡检: master e79f391(vercel修复), 532测试通过, 无pending任务, 黑板0条pending开发任务, A2A asset discovery endpoints任务已done. evomap.ai可访问: GDI四维评分(35%质量+30%使用+20%社信号+15%新鲜度), Node Secret认证(64hex Bearer), AI Council治理(Tier3+), 全部已实现. 项目稳定, 无实质开发任务, 无需创建PR |
| v2.30 | 2026-03-30 12:10 | arch | 巡检: master 212b17a, 532测试通过, gh未认证(无法push/PR). master自12:05新增5个vercel部署修复提交(含dist路径、serverless bundle配置). 黑板1个pending任务(巡检报告,非开发). 无实质开发任务可认领. evomap.ai llms.txt同上次,无新功能差距. 项目稳定, 无需创建PR |
| v2.31 | 2026-03-30 13:24 | arch | 巡检: master 212b17a, 532测试通过, gh未认证(无法push/PR). 黑板0条pending任务. Arena(Chapter 30)确认:Season/Match/Entry/Judgment机制已实现(含被动触发/主动基准/赏金竞技/开放竞技4种触发模式). 无实质开发任务, 项目稳定, 无需创建PR |
| v2.34 | 2026-03-30 15:14 | arch | 巡检: master 7c07bba, 532测试通过, gh未认证(阻塞PR). 发现分支origin/feature/starter-gene-pack-onboarding(71972a3,420行)已推送含Starter Gene Pack(hello响应含starter_gene_pack字段)和Interactive Onboarding Wizard(/onboarding/agent路由)实现,未合并master. 黑板0 pending任务. evomap.ai新增: hello响应含survival_status/referral_code/recommended_tasks/network_manifest字段, claim_code+claim_url用于节点认领, heartbeat接受worker_enabled/worker_domains/max_load/fingerprint更新. 架构已覆盖所有新字段. 项目稳定, 无需创建PR |
| v2.35 | 2026-03-30 15:50 | arch | 巡检: master 7c07bba, 532测试通过, gh未认证. evomap.ai llms.txt同上次无新功能差距, 无实质开发任务, 项目稳定, 无需创建PR |
| v2.36 | 2026-03-30 16:02 | arch | 巡检: master 7c07bba, 532测试通过, gh已认证(token in remote URL). evomap.ai GEP Protocol(Ch16)确认: schema_version 1.5.0✅, epigenetic_marks✅, multi-language signals_match✅ 均已实现. 无新功能差距, 黑板0 pending任务, 项目稳定, 无实质开发任务, 无需创建PR |
| v2.38 | 2026-03-30 16:40 | arch | 巡检: master 21593e2, 532测试通过, gh CLI API未认证(git push OK), 黑板0 pending任务. 确认2个PR待合并: PR #287(Starter Gene Pack+Onboarding Wizard,71972a3,420行,532测试✅)和PR #289(Wiki API对齐,f401894,532测试✅). 无新evomap.ai功能差距, 请@evo合并这两个分支. 项目稳定. |
| v2.39 | 2026-03-30 16:50 | arch | 巡检: master 21593e2, 532测试通过, gh认证成功(git push OK). 确认3个open PRs: #287(Starter Gene Pack+Onboarding Wizard,420行,6文件), #288(inspection report,非代码), #289(Wiki API对齐,200行,2文件). PR #287和#289含实际代码需合并. 无新evomap.ai功能差距, 项目稳定. |
| v2.40 | 2026-03-30 17:35 | arch | 巡检: master 21593e2, 532测试通过, 5个open PRs(#287/#289含代码, #288/#290文档, #291资产推荐端点). gh认证成功. evomap.ai llms.txt同上次无新功能差距. 黑板0 pending任务. 项目稳定. 已发帖提醒@evo合并3个代码PR. |
...
| v2.66 | 2026-03-31 12:10 | arch | 巡检: master e2104a8, 532测试通过, gh未认证(无法gh pr create). 黑板0 pending开发任务(仅巡检报告). evomap.ai GEP Protocol(Ch16)确认: schema_version 1.5.0✅, model_name(Gene/Capsule)✅, trigger_context(Capsule)✅, Mutation类型✅, ValidationReport✅. 确认差距: MemoryGraphEvent.spec定义与src/memory_graph/实现对齐; EvolutionEvent.assets.validation_report_id字段缺失. 项目稳定, 无实质开发任务, 无需创建PR |
| v2.68 | 2026-03-31 14:10 | arch | 巡检: master 7cee0c8, 532测试通过, gh CLI未认证(但git push via token有效). evomap.ai GEP Protocol(Ch16)确认schema_version 1.5.0✅ signals_match支持substr/regex/multi-language✅. Ch03确认heartbeat_interval_ms 5min✅, starter_gene_pack每日刷新GDI≥40✅, recommended_tasks字段✅. 无新功能差距. 黑板0 pending任务. 9个open PRs(5个代码:#303/#301/#300/#297/#296, 4个文档). 已发帖提醒@evo合并代码PRs. 项目稳定, 无需创建PR |
| v2.70 | 2026-03-31 17:10 | arch | 巡检: master d7fc3ec(与origin同步), 532测试通过, gh CLI未认证(git push via token有效). evomap.ai GEP/A2A/Arena/Skill Store/Group Evolution全面确认无新增功能差距(Ch00-32全覆盖). 黑板0 pending任务, 无实质开发任务, 项目稳定, 无需创建PR |
| v2.77 | 2026-03-31 19:20 | arch | 巡检: master 5026efb(已与origin同步), 532测试通过, gh CLI未认证(无法gh pr create). evomap.ai GEP/A2A/Arena/Skill Store/Group Evolution全面确认无新增功能差距(Ch00-32全覆盖). 黑板0 pending任务. 3个未合并feature分支含实际代码: feature/starter-gene-pack-onboarding(71972a3), feature/reading-engine-api(3174c66), fix/swarm-sort-stability(86dc2c1). 项目稳定, 无实质开发任务, 无需创建PR |
| v2.78 | 2026-03-31 19:50 | arch | 巡检: master 5026efb, 532测试通过, gh CLI已认证. evomap.ai llms.txt同v2.77无新功能差距(GEP/A2A/Arena/Skill Store/Group Evolution Ch00-32全覆盖). 黑板0 pending开发任务. 7个未合并分支(origin/feature/guild-join-leave等)请@evo审查合并. 项目稳定, 无实质开发任务, 无需创建PR |
| v2.80 | 2026-03-31 20:20 | arch | 巡检: master 100faef, 532测试通过, gh CLI已认证. evomap.ai GEP/A2A/Arena/Skill Store/Group Evolution Ch00-32全面确认无新增功能差距. 黑板0 pending开发任务. 8个未合并分支(feature/guild-join-leave/a2a-work/swarm-list等)请@evo审查合并. 项目稳定, 无实质开发任务, 无需创建PR |
| v2.81 | 2026-03-31 20:33 | arch | 巡检: master 100faef, 532测试通过, gh CLI已认证. evomap.ai GEP/A2A/Arena/Skill Store/Group Evolution Ch00-32全面确认无新增功能差距. 黑板0 pending开发任务. 项目稳定, 无实质开发任务, 无需创建PR |
| v2.82 | 2026-03-31 20:50 | arch | 巡检: master 100faef, 532测试通过, gh CLI未认证(无法gh pr create). evomap.ai llms.txt同v2.81无新功能差距(Ch00-32全覆盖✅). 黑板0 pending开发任务. 16个未合并分支(origin含多个inspection-report). 项目稳定, 无实质开发任务, 无需创建PR |
| v2.83 | 2026-03-31 21:02 | arch | 巡检: master a16221f(与origin同步), 532测试通过, gh CLI未认证(git push via token有效). A2A Protocol深度确认(Ch05): gep-a2a v1.0.0, 7种消息类型(hello/heartbeat/publish/validate/fetch/report/dialog/session_*), Node Secret Bearer认证(64hex)✅, heartbeat_interval_ms 300000✅, referral bonus(50+100 credits)✅, identity_doc/constitution(8000字符)✅. API Access(Ch28)确认: kg端点(/kg/query,/kg/ingest,/kg/status,/kg/my-graph), API Key格式ek_48hex, 账户密钥管理(POST/GET/DELETE /account/api-keys)✅. 黑板0 pending任务, 无新功能差距, 项目稳定, 无实质开发任务, 无需创建PR |
...
| v2.89 | 2026-03-31 22:50 | arch | 巡检: master 60dc40d(与origin同步), 532测试通过, evomap.ai GEP/A2A/Arena/Skill Store/Group Evolution Ch00-32全面确认无新增功能差距. Ch09 Research Context可访问✅. Ch25 Hub Analytics(页面404)功能已在src/analytics/完整实现: Intent Drift Detection✅ Branching Analysis✅ Timeline Visualization✅ Signal/GDI Forecasting✅ Risk Alerts✅. 黑板0 pending任务, gh CLI未认证, git push via token有效, 项目稳定, 无实质开发任务, 无需创建PR |
| v2.92 | 2026-04-01 01:05 | arch | 巡检: master 3e6ae01(与origin同步), 532测试通过, evomap.ai skill.md/skill-protocol.md/skill-platform.md/skill-advanced.md/skill-structures.md全面可访问. A2A Protocol v1.0.0完整确认(gep-a2a, hello/heartbeat/publish/validate/fetch/report/dialog/session_*✅), Service Marketplace(Ch22)✅, Recipe/Organism/Session/Agent Ask(Ch18-20)✅, Credit Economics✅, Help API✅, Wiki API✅. 黑板0 pending任务, gh CLI未认证(git push via token有效), 无新evomap.ai功能差距, 项目稳定, 无需创建PR |
| v2.90 | 2026-03-31 23:03 | arch | 巡检: master a14ce42(与origin同步), 532测试通过, evomap.ai可访问. A2A Protocol(Ch05)深度确认: gep-a2a v1.0.0✅ hello/heartbeat/publish/validate/fetch/report/dialog/session_*消息类型✅ Node Secret Bearer认证(64hex)✅ heartbeat_interval_ms 300000(5min)✅ referrer字段(50+100 credits奖励)✅ identity_doc/constitution(8000字符)✅ rotate_secret机制✅. Ch03+Ch06确认hello响应: claim_code+claim_url✅ starter_gene_pack✅ survival_status✅ network_manifest✅ available_tasks(max5)✅. 黑板0 pending任务, gh CLI未认证(git push via token有效), 无新evomap.ai功能差距, 项目稳定, 无需创建PR |
...
| v2.73 | 2026-03-31 16:40 | arch | 巡检: master 7cee0c8, 532测试通过, gh CLI未认证(git push via token有效). evomap.ai llms.txt同上次无新功能差距(GEP/A2A/Arena/Skill Store/Group Evolution全部✅). 无pending开发任务可认领, 无实质开发任务, 项目稳定, 无需创建PR. |
| v2.74 | 2026-03-31 16:50 | arch | 巡检: master 7cee0c8, 532测试通过, evomap.ai GEP/A2A/Arena/Skill Store/Group Evolution全面确认无新增功能差距. 多个feature分支待合并(见origin). 黑板0 pending任务, gh未认证(无法gh pr create), 项目稳定, 无需创建PR. |
| v2.75 | 2026-03-31 18:40 | arch | 巡检: master 83e0bee, 532测试通过, gh CLI未认证(git push via token有效). evomap.ai Skill Store(Ch31)深度确认: 4层安全审核(regex/obfuscation/political/Gemini AI)✅, 版本管理(50版上限/patch自增/回滚)✅, 回收站(30天保留/永久删除)✅, 反垃圾规则(500字符最小/85%相似度/5个/24h发布/50次/时下载封禁)✅. 黑板0 pending任务, 无新功能差距, 项目稳定, 无需创建PR. |
| v2.71 | 2026-03-31 15:50 | arch | 巡检: master 7cee0c8, 532测试通过, gh CLI未认证(无法gh pr create, git push via token有效). evomap.ai GEP Protocol/A2A Protocol全面确认无新功能差距(Ch00-32全覆盖). 黑板0 pending任务, 项目稳定, 无实质开发任务, 无需创建PR. 5个open代码PRs待合并(#303/#301/#300/#297/#296), 已提醒@evo合并. |
| v2.67 | 2026-03-31 13:50 | arch | 巡检: master 7cee0c8, 532测试通过, gh API未认证(但git push via token有效). evomap.ai llms.txt同上次无新功能差距(GEP/A2A/Arena/Skill Store/Group Evolution全部实现✅). 黑板0 pending任务. 5个open代码PRs待合并: #303(swarm-list端点), #301(swarm排序稳定), #300(node test污染), #297(filterByMinGrade测试修复), #296(confidence时间冻结). 无实质开发任务可认领, 项目稳定, 无需创建PR |
| v2.64 | 2026-03-31 10:20 | arch | 巡检: master 09be5fd, 532测试通过, gh未认证(无法gh pr create). 黑板0 pending任务. evomap.ai可访问(Ch00-32全面确认). origin/fix/swarm-sort-stability(86dc2c1)已推送待PR合并. 所有核心模块已实现. 项目稳定, 无实质开发任务, 无需创建PR |
| v2.57 | 2026-03-31 08:40 | arch | 巡检: master ffae0a2, 532测试通过, gh未认证(无法gh pr create). 黑板网络异常(连接失败). evomap.ai llms.txt完整可访问, 新增内容无实质差距. 所有核心模块(src/a2a,arena,skill_store,circle,guild,swarm,reading,knowledge,verifiable_trust等37个模块)已实现. 项目稳定, 无实质开发任务, 无需创建PR |
| v2.58 | 2026-03-31 08:50 | arch | 巡检: master 39efe74, 532测试通过, gh未认证. 黑板网络异常(连接失败). evomap.ai Skill Store(Ch31)深度调研: 确认4层安全审核(layer1 regex/layer2 obfuscation/layer3 political/layer4 Gemini AI), 回收站30天保留/永久删除机制, bulk下载防护(50次/时警告/100次/时封禁). Skill Store API端点完整(11个), 版本管理(50版上限), 同前缀3个/24h限制. 项目稳定, 无实质开发任务, 无需创建PR |
| v2.59 | 2026-03-31 09:06 | dev | 巡检: 发现flaky test bug(swarm排序), 修复src/swarm/engine.ts listSwarms: 增加swarm_id作为secondary tiebreaker解决排序不稳定问题(23b58d4). 分支fix/swarm-sort-determinism已推送, PR待合并. 532测试通过. 项目稳定. |
| v2.60 | 2026-03-31 09:20 | dev | 巡检: master 0436883, 532测试通过, gh CLI认证成功(ghtoken in remote URL). **PR #301已创建**: fix/swarm-sort-determinism(23b58d4, src/swarm/engine.ts增swarm_id tiebreaker), 请@evo合并. 黑板网络异常(连接失败), 无pending任务可查看/创建. evomap.ai Skill Store(Ch31)完整确认: 11个端点(含versions/update/rollback/delete-version等版本管理, 以及visibility/rollback/permanent-delete等回收站功能)均已在src/skill_store/实现✅. 项目稳定. |
| v2.61 | 2026-03-31 09:33 | arch | 巡检: master 8633b69, 532测试通过, gh CLI API未认证(git push OK但gh pr create不可用). origin/fix/swarm-sort-determinism(23b58d4)仍在origin待合并. 黑板网络异常(连接失败). evomap.ai Ch03+Ch06新增: 15min无活动标记offline(代码注释15min vs spec 5min已知差异), starter_gene_pack每日刷新GDI≥40基因, billing文档确认"Promotion is NOT automatic"——仅高质量资产晋升, 多维AI评审(intrinsic35%+usage30%+social20%+freshness15%). 无新实质功能差距, 项目稳定, 无需创建PR. PR #301(23b58d4)待@evo合并. |
| v2.63 | 2026-03-31 09:50 | dev | 巡检: master 2bc74e8→86dc2c1, 532测试通过. 发现flaky test: listSwarms sort无tiebreaker导致created_at相同时排序不稳定. 修复: src/swarm/engine.ts增swarm_id tiebreaker (a.swarm_id.localeCompare(b.swarm_id))确保新swarm_id优先. 分支fix/swarm-sort-stability(86dc2c1)已推送, PR待手动创建(git push OK, gh API token无效). 黑板网络异常(连接失败). evomap.ai无新功能差距. 项目稳定. |
...
| v2.62 | 2026-03-31 09:40 | arch | 巡检: master 8633b69→a4306c1(rebase fix/swarm-sort-determinism), 532测试通过. 重新base fix/swarm-sort-determinism onto master并推送. gh CLI仍无API认证(git push OK但gh pr create失败), PR #301待手动创建或修复gh auth. evomap.ai GEP Protocol Ch16确认: 6种资产类型(Gene/Capsule/EvolutionEvent/Mutation/ValidationReport/MemoryGraphEvent)全部字段已覆盖, schema_version 1.5.0✅, epigenetic_marks✅, multi-language signals_match✅. 黑板网络异常(连接失败). 项目稳定.
...
| v2.92 | 2026-04-01 00:10 | arch | 巡检: master 2098f62(与origin同步), 532测试通过, evomap.ai GEP Protocol v1.0.0确认(gep-a2a✅, hello/heartbeat/publish/validate/fetch/report/dm/session_*✅, Node Secret Bearer 64hex✅, heartbeat_interval_ms 300000✅, GDI四维评分(35%质量+30%使用+20%社信号+15%新鲜度)✅, Model Tier Gate✅, AI Council治理✅, Direct Messaging✅, Agent Sessions✅, Official Projects✅, Starter Gene Pack✅, claim_code/claim_url✅). Ch00-32全覆盖无新增差距. 黑板0 pending任务, gh未认证, 项目稳定, 无需创建PR
