...
export const MOCK_USER_ID = 'usr_01J8K4M6N7P9Q2R3S5T6U7V8W';
export const MOCK_WORKSPACE_ID = 'ws_01J8K4M6N7P9Q2R3S5T6U7V8W';
...
export { authHandlers, bffAuthHandlers, sessionHandlers } from './handlers-auth';
export { bountyHandlers, mockBounty, mockBountyList } from './handlers-bounty';
export { workspaceHandlers, mockWorkspace, mockWorkspaceMembers, mockGoals, mockTasks, mockWorkers } from './handlers-workspace';
...
export const handlers = [
  ...
  // Returns { items: Asset[] } to match apiClient.getAssets() which extracts r.items
  http.get('http://localhost:3001/a2a/assets', ({ request }) => {
    ...
    return HttpResponse.json({
      items: assets.slice(start, start + limit),
    });
  }),
  ...
  // Returns { success, assets, total, data } to match real backend response shape
