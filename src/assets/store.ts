...
export function saveAsset(
  ...
  const newRecord: AssetRecord = {
    ...
    gdi: effectiveGdi,
    fetch_count: passedFetchCount !== undefined ? passedFetchCount : (existing?.fetch_count ?? 0),
    report_count: passedReportCount !== undefined ? passedReportCount : (existing?.report_count ?? 0),
