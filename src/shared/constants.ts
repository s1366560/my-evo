...
export const API_KEY_DISPLAY_PREFIX = 8;
...
// ===== OAuth2 =====
export const OAUTH_STATE_EXPIRY_MS = 600_000; // 10 minutes
export const OAUTH_CODE_EXPIRY_MS = 600_000; // 10 minutes
export const OAUTH_ACCESS_TOKEN_EXPIRY_MS = 3_600_000; // 1 hour
export const OAUTH_REFRESH_TOKEN_EXPIRY_MS = 2_592_000_000; // 30 days
export const OAUTH_MAX_CODE_LENGTH = 128;
export const OAUTH_MIN_CODE_LENGTH = 43;
